...
from Crypto.Cipher import Blowfish, CAST, DES3
...
class ezPyCryptoException(Exception): pass
...
class key:
    ...
    _algosSes = { "ARC2":None, "Blowfish":Blowfish, "CAST":CAST,
                  "DES3":DES3, "IDEA":None, "RC5":None}
    _algosSes1 = {'ARC2':0, 'Blowfish':1, 'CAST':2, 'DES3':3, 'IDEA':4, 'RC5':5}

    _algosSes2 = [None, Blowfish, CAST, DES3, None, None]

    _algosSes3 = {None:'ARC2', Blowfish:'Blowfish', CAST:'CAST',
                  DES3:'DES3', None:'IDEA', None:'RC5'}
    ...
    def __init__(self, something = 512, algoPub=None, algoSess=None, **kwds):
        ...
        Arguments:
         1. If new keys are desired:
             ...
             - algoSess - one of 'Blowfish', 'CAST', 'DES3'
               (default 'Blowfish')
        ...
        if type(something) is types.IntType:
            ...
            if algoP == None:
                ...
                raise ezPyCryptoException("AlgoPub must be one of 'ElGamel', 'RSA' or 'DSA'")
            self.algoPub = algoP
            ...
            if algoS == None:
                ...
                raise ezPyCryptoException("AlgoSess must be one of AES/Blowfish/CAST/DES/DES3")
            self.algoSes = algoS
            ...
            if algoPub != None:
                raise ezPyCryptoException("Don't specify algoPub if importing a key")
            ...
            raise ezPyCryptoException("Must pass keysize or importable keys")
    ...
    def importKey(self, keystring, **kwds):
        ...
        try:
            ...
            #raise ezPyCryptoException("Tried to import Invalid Key")
            self._calcPubBlkSize()
            self.passphrase = passphrase
            return True
        except:
    ...
    def decStringFromAscii(self, enc):
        ...
        ezPyCryptoException will also occur if this object is not holding a private key
            ...
            if self._decState == 'p':
                ...
                if chunklen < size + 2:
                    ...
                    if not self._testPubKey(pubkey):
                        raise ezPyCryptoException("Can't decrypt - public key mismatch")
    ...
    def _unwrap(self, type, msg):
        ...
        try:
            ...
            raise ezPyCryptoException("Tried to import Invalid %s" % type)
            self._calcBlkSize()
